		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fitnessweights-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fitnessweights-display": {
								"semanticObject": "fitnessweights",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fitness.weights",
									"url": sap.ui.require.toUrl("fitness/weights")
								}
							}
						}
					}
