					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation Deneme",
									"targetURL": "#navmedium-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"navmedium-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nav.medium",
									"url": sap.ui.require.toUrl("nav/medium")
								}
							}
						}
					}
