		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#statisticspremierleague-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"statisticspremierleague-display": {
								"semanticObject": "statisticspremierleague",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=statistics.premierleague",
									"url": sap.ui.require.toUrl("statistics/premierleague")
								}
							}
						}
					}
