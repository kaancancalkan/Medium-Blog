		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fioricalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioricalculator-display": {
								"semanticObject": "fioricalculator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.calculator",
									"url": sap.ui.require.toUrl("fiori/calculator")
								}
							}
						}
					}
