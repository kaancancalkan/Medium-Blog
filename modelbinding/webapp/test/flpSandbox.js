		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Model Binding",
									"targetURL": "#modelbindingmodelbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"modelbindingmodelbinding-display": {
								"semanticObject": "modelbindingmodelbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=modelbinding.modelbinding",
									"url": sap.ui.require.toUrl("modelbinding/modelbinding")
								}
							}
						}
					}
